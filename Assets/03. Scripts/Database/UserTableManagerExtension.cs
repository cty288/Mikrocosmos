...
public static class UserTableManagerExtension {
    ...
    /// <returns></returns>
    public static async Task<User> SearchUsername(this NHibernateTableManager<User> table, string username)
    {
    ...
    /// <returns></returns>
    public static async Task<User> SearchPlayfabid(this NHibernateTableManager<User> table, string playfabid)
    {
